...
function ContactForm() {
  ...
  return (
    <section id="contact" className="min-h-screen w-full relative overflow-hidden bg-dark-900 flex items-center justify-center py-20 px-4">
      <div className="bg-dark-800 rounded-2xl p-8 w-full max-w-md shadow-2xl">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-burgundy-500 mb-2">Get in touch</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="Message..."
              rows={4}
              className="w-full bg-dark-1000 text-white rounded-2xl py-4 px-4 focus:outline-none focus:bg-[#EFDDDD99] placeholder-gray-400 resize-none"
            />
          </div>
          ...
          <button
            ...
            className="w-full bg-burgundy-500 hover:bg-burgundy-600 text-white font-semibold py-4 rounded-full transition-colors duration-200 flex items-center justify-center gap-2"
          >
            <Send size={20} />
            Send Message
          </button>
